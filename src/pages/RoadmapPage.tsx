...
const roadmapData: RoadmapItem[] = [
  ...
  { title: "Add daily performance in trading journal", status: "planned" },
  { title: "Add user authentication", status: "planned" },
  { title: "Optimize backend backtest class", status: "planned" },
  { title: "Add trading analytics in trading journal", status: "planned" },
